...
class _PrintingPdfState extends State<PrintingPdf> {
  ...
  void _createPdf() async {
    ...
    await Printing.layoutPdf(format: PdfPageFormat.a4.landscape, onLayout: (PdfPageFormat format) async => doc.save());
  ...
  void generatePdf() async {
    ...
    await Printing.layoutPdf( format: PdfPageFormat.a4.landscape ,onLayout: (formatT) => _generatePdf(formatT, title));
  }
